(function(){
    ...
    function throwDice(){
        ...
        if(gameData.rollSum === 2) {
            ...
            gameData.index ? (gameData.index = 0) : (gameData.index =1);
            game.innerHTML += `<p id="sorry">Sorry, one of your rolls was a 1, switching to ${gameData.players[gameData.index]}</p>`;
            setTimeout(setUpTurn, 2000);
        } else {
    ...
    function checkWinningCondition() {
        if(gameData.score[gameData.index] > gameData.gameEnd) {
            ...
            game.innerHTML += `<p id='sorry'>${gameData.players[gameData.index]} wins with ${gameData.score[gameData.index]} points! Congratulations!</p>`;
